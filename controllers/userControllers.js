...
//@access          Public
//searching users based on a keyword
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //if user not in DB i create new user
  ...
  // checks if a user was successfully created. If so, it responds with a 201 status (Created) and sends a JSON response containing the user's ID, name, email, isAdmin
